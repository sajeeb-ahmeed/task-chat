...
No supplied-backend fixes, Firefox/WebKit or real-device coverage, evaluator repository access, or recruiter submission are claimed. The repository is private. The document's deadline and submission destination need external confirmation before submission.
